...
trait HasRelationships
{
    ...
    public function hasMany($related, $foreignKey = null, $localKey = null)
    {
        ...
        return $this->ExtendednewHasMany(
    ...
    {
        return new \App\Http\Extends\HasMany($query, $parent, $foreignKey, $localKey);
    }
                                  ...
                                  $parentKey = null, $relatedKey = null, $relation = null)
    {
        ...
        var_dump('execution 2');




        if ($foreignPivotKey){
            $foreignPivotKey = Str::snake($foreignPivotKey);
        }
